...
public class PropertiesBSFragment extends BottomSheetDialogFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        TextView txtFixFrame = view.findViewById(R.id.txtFixFrame);
...
//        sbBrushSize.setOnSeekBarChangeListener(this);
        ...
        txtFixFrame.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mProperties.fixeFrameChange();
                dismiss();
            }
        });
    }
