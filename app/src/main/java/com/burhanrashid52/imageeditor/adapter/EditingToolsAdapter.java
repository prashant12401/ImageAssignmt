...
public class EditingToolsAdapter extends RecyclerView.Adapter<EditingToolsAdapter.ViewHolder> {
    ...
    public EditingToolsAdapter(OnItemSelected onItemSelected) {
        ...
        mToolList.add(new ToolModel("Upload", R.drawable.ic_photo_upload, ToolType.UPLOAD));
        ...
        mToolList.add(new ToolModel("Preview", R.drawable.ic_photo_filter, ToolType.PREVIEW));
        mToolList.add(new ToolModel("List", R.drawable.ic_list, ToolType.LIST));
